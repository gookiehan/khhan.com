...
const BASE = "http://khhan.com/wp-content/uploads";
function F(path){ return BASE + "/" + path; }
...
const qeaThesis = {
  ...
  files: [{ url: F("2023/09/PhDthesis_QEA.pdf"), icon: "📄", tip: "박사논문 PDF" }]
};
...
const qeaJournals = [
  {
    ...
    files: [{ url: F("2023/09/PRL2004_Face.pdf"), icon: "📄", tip: "PDF" }]
  },
  {
    ...
    files: [
      { url: F("2023/09/TEVC2004_V8N2.pdf"), icon: "📄", tip: "PDF" },
      { url: F("2023/09/knapsack_data.zip"), icon: "📦", tip: "Knapsack Data" }
    ]
  },
  {
    ...
    files: [{ url: F("2023/09/IEICE_QDM2003.pdf"), icon: "📄", tip: "PDF" }]
  },
  {
    ...
    files: [
      { url: F("2023/09/TEVC2002_V6N6.pdf"), icon: "📄", tip: "PDF" },
      { url: F("2023/09/knapsack_data.zip"), icon: "📦", tip: "Knapsack Data" }
    ]
  }
];
...
const qeaConferences = [
  {
    ...
    files: [{ url: F("2023/09/CEC2006_QEAanalysis.pdf"), icon: "📄", tip: "PDF" }]
  },
  {
    ...
    files: [{ url: F("2023/09/CEC2006_QMEA.pdf"), icon: "📄", tip: "PDF" }]
  },
  {
    ...
    files: [{ url: F("2023/09/CEC2004_Face.pdf"), icon: "📄", tip: "PDF" }]
  },
  {
    ...
    files: [{ url: F("2023/09/CEC2003-QEA.pdf"), icon: "📄", tip: "PDF" }]
  },
  {
    ...
    files: [
      { url: F("2023/09/GECCO2003_FACE.pdf"), icon: "📄", tip: "PDF" },
      { url: F("2024/02/gecco2003_UIUC.jpg"), icon: "🖼️", tip: "GECCO UIUC" }
    ]
  },
  {
    ...
    files: [
      { url: F("2023/09/GECCO2003_QEA.pdf"), icon: "📄", tip: "PDF" },
      { url: F("2024/02/gecco2003chicago.jpg"), icon: "🖼️", tip: "Chicago" }
    ]
  },
  {
    ...
    files: [{ url: F("2023/09/QEAFIRA.pdf"), icon: "📄", tip: "PDF" }]
  },
  {
    ...
    files: [
      { url: F("2023/09/IC-AI2001.pdf"), icon: "📄", tip: "PDF" },
      { url: F("2023/09/icai1.jpg"), icon: "🖼️", tip: "사진 1" },
      { url: F("2023/09/icai2.jpg"), icon: "🖼️", tip: "사진 2" }
    ]
  },
  {
    ...
    files: [
      { url: F("2023/09/CEC2001.pdf"), icon: "📄", tip: "PDF" },
      { url: F("2023/09/cec2001.jpg"), icon: "🖼️", tip: "사진" }
    ]
  },
  {
    ...
    files: [
      { url: F("2023/09/cec2000.pdf"), icon: "📄", tip: "PDF" },
      { url: F("2023/09/knapsack_data.zip"), icon: "📦", tip: "Knapsack Data" },
      { url: F("2024/02/cec2000.jpg"), icon: "🖼️", tip: "사진" }
    ]
  }
];
...
const qeaDomestic = [
  {
    ...
    files: [{ url: F("2024/02/QMOEAKACC05.pdf"), icon: "📄", tip: "PDF" }]
  }
];
...
const education = [
  {
    ...
    files: [
      { url: F("2023/09/PhDthesis_QEA.pdf"), icon: "📄", tip: "박사논문 PDF" }
    ]
  },
  {
...
const career = [
  ...
  },
  {
    ...
    files: [
      { url: F("2023/09/HiddenChampion100.pdf"), icon: "📄", tip: "강소기업100 PDF" },
...
/* ──────────── 수상경력 ──────────── */
const awards = [
  { date: "2023. 11.", title: "제8회 3D프린팅 BIZCON 경진대회 최우수상 – 특허청장상", files: [{ url: F("2024/02/3DPrintingBizcon_2023.jpg"), icon: "🖼️", tip: "수상 사진" }] },
  { date: "2023. 10.", title: '뿌리산업 발전 유공자 – 산업통상자원부장관 표창, <a href="https://www.motie.go.kr/">산업통상자원부</a>', files: [{ url: F("2024/02/PPURI_2023.pdf"), icon: "📄", tip: "표창장 PDF" }] },
  { date: "2022. 11.", title: '2022 3D프린팅 활용 우수사례 경진대회 최우수상 – 과학기술정보통신부 장관상(삼영기계), <a href="https://www.msit.go.kr/index.do">과학기술정보통신부</a>', files: [{ url: F("2023/09/3DP_MSIT_2022.pdf"), icon: "📄", tip: "상장 PDF" }, { url: "http://amenews.kr/news/view.php?idx=51408", icon: "📰", tip: "AM뉴스" }] },
  ...
  { date: "2022. 9.", title: '2022 전국뿌리기술경기대회(주조분야) – 중소벤처기업부 장관상(삼영기계), <a href="https://www.msit.go.kr/index.do">과학기술정보통신부</a>', files: [{ url: F("2023/09/CastingTech_2022.jpg"), icon: "🖼️", tip: "수상 사진" }, { url: "http://amenews.kr/news/view.php?idx=50497", icon: "📰", tip: "AM뉴스" }] },
  { date: "2021. 11.", title: '3D프린팅 산업발전 유공자 – 과학기술정보통신부장관 표창, <a href="https://www.msit.go.kr/index.do">과학기술정보통신부</a>', files: [{ url: F("2023/09/3DP_MSIT_2021.pdf"), icon: "📄", tip: "표창장 PDF" }, { url: "https://news.mt.co.kr/mtview.php?no=2021112410114019744", icon: "📰", tip: "머니투데이" }] },
  { date: "2021. 11.", title: '2021 3D프린팅 활용 우수사례 경진대회 – 우수상(삼영기계), <a href="https://www.nipa.kr/index.jsp">정보통신산업진흥원</a>', files: [{ url: F("2023/09/3DP_NIPA_2021.pdf"), icon: "📄", tip: "상장 PDF" }] },
  { date: "2021. 10.", title: '뿌리산업 혁신과 3D프린팅 확산 공로 – 국회 과학기술정보방송통신위원회 위원장 표창, <a href="https://science.na.go.kr:444/science/index.do">과학기술정보방송통신위원회</a>', files: [{ url: F("2023/09/3DP_NationalAssembly_2021.pdf"), icon: "📄", tip: "표창장 PDF" }, { url: F("2024/02/3DP_NationalAssembly_2021.jpg"), icon: "🖼️", tip: "수상 사진" }] },
  { date: "2021. 9.", title: '2021 전국뿌리기술경기대회(주조분야) – 중소벤처기업부 장관상(삼영기계), <a href="https://www.mss.go.kr/site/smba/main.do">중소벤처기업부</a>', files: [{ url: F("2023/09/CastingTech_2021.jpg"), icon: "🖼️", tip: "수상 사진" }, { url: "https://news.mt.co.kr/mtview.php?no=2021110112384013589", icon: "📰", tip: "머니투데이" }] },
  { date: "2020. 12.", title: '3D프린팅 경진대회(Innovation Challenge) 최우수상 – 과학기술정보통신부 장관상(삼영기계), <a href="https://www.msit.go.kr/index.do">과학기술정보통신부</a>', files: [{ url: F("2024/02/3DP_NIPA_2020.pdf"), icon: "📄", tip: "상장 PDF" }, { url: "http://amenews.kr/news/view.php?idx=43860", icon: "📰", tip: "AM뉴스" }] },
  { date: "2020. 11.", title: '한국정밀공학회 2020 통합학술대회 – 최우수논문상, <a href="http://www.kspe.or.kr/">한국정밀공학회</a>', files: [{ url: F("2023/09/BestPaperAward_KSPE2020.pdf"), icon: "📄", tip: "상장 PDF" }] },
  { date: "2020. 9.", title: '제4회 DfAM 경진대회 – 동상, <a href="http://www.kamug.or.kr/index.php?theme=KAMUG">한국3D프린팅사용자협회</a>', files: [{ url: F("2024/02/DfAM_prize_2020.pdf"), icon: "📄", tip: "상장 PDF" }] },
  { date: "2019. 12.", title: '대한민국 기술사업화대전 – 기술사업화부문 산업통상자원부장관 표창, <a href="http://www.motie.go.kr/www/main.do">산업통상자원부</a>', files: [{ url: F("2023/09/Minister_Award_201912.pdf"), icon: "📄", tip: "표창장 PDF" }, { url: F("2023/09/20191212_award.jpg"), icon: "🖼️", tip: "수상 사진" }, { url: "http://www.joongdo.co.kr/main/view.php?key=20191213010005855", icon: "📰", tip: "중도일보" }] },
  { date: "2019. 9.", title: "전국주조기술경기대회 단체전(삼영기계) 1위 – 국무총리상 수상", files: [{ url: F("2023/09/CastingTech_2019.pdf"), icon: "📄", tip: "상장 PDF" }] },
  { date: "2017. 12.", title: '대한민국 3D프린팅 산업발전 대상 유공자 – 정보통신산업진흥원장 표창, <a href="http://www.nipa.kr/main.html">정보통신산업진흥원</a>', files: [{ url: F("2023/09/3DP_NIPA_2017.pdf"), icon: "📄", tip: "표창장 PDF" }] },
  { date: "2017. 09.", title: "도전 K-스타트업 본선진출 – 100팀", files: [] },
  { date: "2017. 07.", title: "대한민국 창업대전 지역예선 – 최우수상", files: [{ url: F("2023/09/LUMOS_award_2017.pdf"), icon: "📄", tip: "상장 PDF" }] },
  { date: "2015. 06.", title: "품질경영 유공자 도지사상", files: [{ url: F("2023/09/QM_award_201506.pdf"), icon: "📄", tip: "상장 PDF" }] },
  ...
  { date: "2003. 2.", title: '제 9회 삼성 휴먼테크논문대상 – 금상 – "2상 양자 진화 알고리즘"', files: [{ url: F("2023/09/TPQEA_Humantech2002.pdf"), icon: "📄", tip: "논문 PDF" }, { url: F("2023/09/humantech_9th_1.jpg"), icon: "🖼️", tip: "사진 1" }, { url: F("2023/09/humantech_9th_2.jpg"), icon: "🖼️", tip: "사진 2" }] },
  { date: "2001. 8.", title: '<a href="http://www.fira.net/">FIRA</a> Cup China 2001 – Middle League MiroSot 부문 2위', files: [{ url: F("2024/02/soty5.jpg"), icon: "🖼️", tip: "SOTY5 사진" }, { url: F("2024/02/simulator1.bmp"), icon: "🖼️", tip: "시뮬레이터" }, { url: F("2023/09/fira2001.jpg"), icon: "🖼️", tip: "FIRA 2001" }] },
  { date: "2001. 5.", title: "FIRA-KAIST Cup 2001 – Small League MiroSot 부문 1위", files: [] },
  { date: "2001. 2.", title: '제 7회 삼성 휴먼테크논문대상 – 동상 – "양자 진화 알고리즘"', files: [{ url: F("2023/09/Humantech2000S.pdf"), icon: "📄", tip: "논문 PDF" }, { url: F("2023/09/humantech0.jpg"), icon: "🖼️", tip: "사진 1" }, { url: F("2023/09/humantech1.jpg"), icon: "🖼️", tip: "사진 2" }] },
  { date: "2000. 11.", title: "Feel KAIST 2000 논문 발표 컨테스트 – 영어부문 특별상", files: [] },
  { date: "1997. 6.", title: "세계 마이크로로봇 축구 대회 '97 – S-MiroSot 부문 2위", files: [{ url: F("2024/02/robot1.jpg"), icon: "🖼️", tip: "로봇 사진" }, { url: F("2024/02/mirage1.jpg"), icon: "🖼️", tip: "MIRAGE 사진" }] },
  { date: "1996. 11.", title: "세계 마이크로로봇 축구 대회 '96 – 공로상", files: [{ url: F("2024/02/mirage3.jpg"), icon: "🖼️", tip: "MIRAGE 사진" }] },
  ...
  { date: "1992. 10.", title: '제 38회 <a href="http://www.science.go.kr/">전국과학전람회</a> 대통령상 – "격자에의해 생기는 물결무늬의 해석과 그 응용에 관한 연구"', files: [{ url: F("2023/09/moire.pdf"), icon: "📄", tip: "논문 PDF" }] },
...
const activities = {
  ...
  invitedTalks: [
    ...
    { date: "2018.04.02.", title: '"융합프로젝트 이야기", <a href="http://celt.kaist.ac.kr/html/main.php">교수학습혁신센터</a>, <a href="http://www.kaist.ac.kr/html/kr/index.html">KAIST</a>', files: [{ url: F("2023/09/convergence_talk_KAIST_2018.jpg"), icon: "🖼️", tip: "사진" }] },
    { date: "2017.11.06.", title: '"Designing new things that you have never seen before," <a href="http://dhe.unist.ac.kr/">School of Design & Human Engineering Seminar</a>, <a href="http://www.unist.ac.kr/">UNIST</a>', files: [{ url: F("2023/09/UNIST_talk_201708.pdf"), icon: "📄", tip: "발표자료 PDF" }] },
...
const intlJournals = [
  ...
  { citation: 'Jun-Su Jang, <b>Kuk-Hyun Han</b> and Jong-Hwan Kim, "Evolutionary algorithm-based face verification," <i>Pattern Recognition Letters</i>, Elsevier B. V., Vol. 25, No. 16, pp. 1857-1865, December 2004.', files: [{ url: F("2023/09/PRL2004_Face.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: '<b>Kuk-Hyun Han</b> and Jong-Hwan Kim, "Quantum-inspired Evolutionary Algorithms with a New Termination Criterion, Hε Gate, and Two Phase Scheme," <i>IEEE Transactions on Evolutionary Computation</i>, IEEE Press, Vol. 8, No. 2, pp. 156-169, April 2004.', files: [{ url: F("2023/09/TEVC2004_V8N2.pdf"), icon: "📄", tip: "PDF" }, { url: F("2023/09/knapsack_data.zip"), icon: "📦", tip: "Knapsack Data" }] },
  { citation: 'Kyung-Ho Kim, Joo-Young Hwang, <b>Kuk-Hyun Han</b>, Jong-Hwan Kim and Kyu-Ho Park, "A Quantum-inspired Evolutionary Computing Algorithm for Disk Allocation Method," <i>IEICE Transactions on Information and Systems</i>, IEICE Press, Vol. E86-D, No. 3, pp. 645-649, March 2003.', files: [{ url: F("2023/09/IEICE_QDM2003.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: '<b>Kuk-Hyun Han</b> and Jong-Hwan Kim, "Quantum-inspired Evolutionary Algorithm for a Class of Combinatorial Optimization," <i>IEEE Transactions on Evolutionary Computation</i>, IEEE Press, Vol. 6, No. 6, pp. 580-593, December 2002.', files: [{ url: F("2023/09/TEVC2002_V6N6.pdf"), icon: "📄", tip: "PDF" }, { url: F("2023/09/knapsack_data.zip"), icon: "📦", tip: "Knapsack Data" }] },
  { citation: '<b>Kuk-Hyun Han</b>, Sinn Kim, Yong-Jae Kim and Jong-Hwan Kim, "Internet Control Architecture for Internet-Based Personal Robot," <i>Autonomous Robots Journal</i>, Kluwer Academic Publishers, Vol. 10, No. 2, pp. 135-147, March 2001.', files: [{ url: F("2023/09/ARJ2001.pdf"), icon: "📄", tip: "PDF" }] }
];
...
const intlConferences = [
  ...
  { citation: 'Sang-Jun Han, <b>Kuk-Hyun Han</b>, Pil Seung Yang and Bo Hyun Kyung, "Tracking the Position of a Mobile Device on Interactive Screens with RFID," in <i>Proceedings of the Sketches, SIGGRAPH Asia 2008</i>, ACM SIGGRAPH, December 2008.', files: [{ url: F("2023/09/SIGGRAPH_AISA2008_Simplicity.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: 'Walter D. Stiehl, Cynthia Breazeal, <b>Kuk-Hyun Han</b>, Jeff Lieberman, Levi Lalla, Allan Maymin, Jonathan Salinas, Daniel Fuentes, Robert Toscano, Cheng Hao Tong, Aseem Kishore, Matt Berlin and Jesse Gray, "The Huggable: A Therapeutic Robotic Companion for Relational, Affective Touch," demonstrated in <i>the Emerging Technologies, SIGGRAPH 2006</i>, ACM SIGGRAPH, August 2006.', files: [{ url: F("2023/09/SIGGRAPH2006_Huggable.pdf"), icon: "📄", tip: "PDF" }, { url: F("2023/09/SIGGRAPH2006.wmv"), icon: "🎬", tip: "Video" }, { url: F("2024/02/SIGGRAPH06_TeamPhoto.jpg"), icon: "🖼️", tip: "Team Photo" }, { url: F("2024/02/SIGGRAPH06_Huggable1.jpg"), icon: "🖼️", tip: "Huggable 1" }, { url: F("2024/02/SIGGRAPH06_Huggable2.jpg"), icon: "🖼️", tip: "Huggable 2" }] },
  { citation: '<b>Kuk-Hyun Han</b> and Jong-Hwan Kim, "On the Analysis of the Quantum-inspired Evolutionary Algorithm with a Single Individual," in <i>Proceedings of the 2006 IEEE Congress on Evolutionary Computation</i>, IEEE Press, pp. 9172-9179, July 2006.', files: [{ url: F("2023/09/CEC2006_QEAanalysis.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: 'Yehoon Kim, Jong-Hwan Kim and <b>Kuk-Hyun Han</b>, "Quantum-inspired Multiobjective Evolutionary Algorithm for Multiobjective 0/1 Knapsack Problems," in <i>Proceedings of the 2006 IEEE Congress on Evolutionary Computation</i>, IEEE Press, pp. 9151-9156, July 2006.', files: [{ url: F("2023/09/CEC2006_QMEA.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: 'Jun-Su Jang, <b>Kuk-Hyun Han</b> and Jong-Hwan Kim, "Face Detection using Quantum-inspired Evolutionary Algorithm," in <i>Proceedings of the 2004 IEEE Congress on Evolutionary Computation</i>, IEEE Press, pp. 2100-2106, June 2004.', files: [{ url: F("2023/09/CEC2004_Face.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: '<b>Kuk-Hyun Han</b> and Jong-Hwan Kim, "On Setting the Parameters of Quantum-inspired Evolutionary Algorithm for Practical Applications," in <i>Proceedings of the 2003 IEEE Congress on Evolutionary Computation</i>, IEEE Press, pp. 178-184, December 2003.', files: [{ url: F("2023/09/CEC2003-QEA.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: 'Jun-Su Jang, <b>Kuk-Hyun Han</b> and Jong-Hwan Kim, "Quantum-inspired Evolutionary Algorithm-based Face Verification," <i>Lecture Notes in Computer Science (GECCO 2003)</i>, eds. E. Cantu-Paz et al., Berlin Heidelberg: Springer-Verlag, Vol. 2724, pp. 2147-2156, July 2003.', files: [{ url: F("2023/09/GECCO2003_FACE.pdf"), icon: "📄", tip: "PDF" }, { url: F("2024/02/gecco2003_UIUC.jpg"), icon: "🖼️", tip: "GECCO UIUC" }] },
  { citation: '<b>Kuk-Hyun Han</b> and Jong-Hwan Kim, "On Setting the Parameters of QEA for Practical Applications: Some Guidelines based on Empirical Evidence," <i>Lecture Notes in Computer Science (GECCO 2003)</i>, eds. E. Cantu-Paz et al., Berlin Heidelberg: Springer-Verlag, Vol. 2723, pp. 427-428, July 2003.', files: [{ url: F("2023/09/GECCO2003_QEA.pdf"), icon: "📄", tip: "PDF" }, { url: F("2024/02/gecco2003chicago.jpg"), icon: "🖼️", tip: "Chicago" }] },
  { citation: '<b>Kuk-Hyun Han</b>, Yong-Jae Kim, Jong-Hwan Kim and Steve Hsia, "Internet Control of Personal Robot between KAIST and UC Davis," in <i>Proceedings of the IEEE International Conference on Robotics and Automation</i>, IEEE Press, pp. 2184-2189, May 2002.', files: [{ url: F("2023/09/ICRA2002.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: '<b>Kuk-Hyun Han</b> and Jong-Hwan Kim, "Introduction of Quantum-inspired Evolutionary Algorithm," in <i>Proceedings of the 2002 FIRA Robot World Congress</i>, pp. 243-248, May 2002.', files: [{ url: F("2023/09/QEAFIRA.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: '<b>Kuk-Hyun Han</b> and Jong-Hwan Kim, "Direct Internet Control Architecture for Personal Robot," in <i>Proceedings of the 2002 FIRA Robot World Congress</i>, pp. 264-268, May 2002.', files: [{ url: F("2023/09/IPRFIRA.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: '<b>Kuk-Hyun Han</b>, Kang-Hee Lee, Choon-Kyoung Moon, Hoon-Bong Lee and Jong-Hwan Kim, "Robot Soccer System of SOTY 5 for Middle League MiroSot," in <i>Proceedings of the 2002 FIRA Robot World Congress</i>, pp. 632-635, May 2002.', files: [{ url: F("2023/09/Soty5FIRA.pdf"), icon: "📄", tip: "PDF" }, { url: F("2024/02/simulator1.bmp"), icon: "🖼️", tip: "Simulator" }, { url: F("2023/09/fira2002.jpg"), icon: "🖼️", tip: "FIRA 2002" }] },
  { citation: '<b>Kuk-Hyun Han</b> and Jong-Hwan Kim, "Analysis of Quantum-inspired Evolutionary Algorithm," in <i>Proceedings of the 2001 International Conference on Artificial Intelligence</i>, CSREA Press, Vol. 2, pp. 727-730, June 2001.', files: [{ url: F("2023/09/IC-AI2001.pdf"), icon: "📄", tip: "PDF" }, { url: F("2023/09/icai1.jpg"), icon: "🖼️", tip: "사진 1" }, { url: F("2023/09/icai2.jpg"), icon: "🖼️", tip: "사진 2" }] },
  { citation: '<b>Kuk-Hyun Han</b>, Shin Kim, Yong-Jae Kim, Seong-Eun Lee and Jong-Hwan Kim, "Implementation of Internet-Based Personal Robot with Internet Control Architecture," in <i>Proceedings of the IEEE International Conference on Robotics and Automation</i>, IEEE Press, pp. 217-222, May 2001.', files: [{ url: F("2023/09/ICRA2001.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: 'Jong-Hwan Kim, <b>Kuk-Hyun Han</b>, Shin Kim and Yong-Jae Kim, "Internet-Based Personal Robot System using Map-Based Localization," in <i>Proceedings of the 32nd International Symposium on Robotics</i>, pp. 1282-1287, April 2001.', files: [{ url: F("2023/09/ISR2001.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: '<b>Kuk-Hyun Han</b>, Kui-Hong Park, Chi-Ho Lee and Jong-Hwan Kim, "Parallel Quantum-inspired Genetic Algorithm for Combinatorial Optimization Problem," in <i>Proceedings of the 2001 IEEE Congress on Evolutionary Computation</i>, IEEE Press, pp. 1422-1429, May 2001.', files: [{ url: F("2023/09/CEC2001.pdf"), icon: "📄", tip: "PDF" }, { url: F("2023/09/cec2001.jpg"), icon: "🖼️", tip: "사진" }] },
  { citation: '<b>Kuk-Hyun Han</b> and Jong-Hwan Kim, "Genetic Quantum Algorithm and its Application to Combinatorial Optimization Problem," in <i>Proceedings of the 2000 IEEE Congress on Evolutionary Computation</i>, IEEE Press, pp. 1354-1360, July 2000.', files: [{ url: F("2023/09/cec2000.pdf"), icon: "📄", tip: "PDF" }, { url: F("2023/09/knapsack_data.zip"), icon: "📦", tip: "Knapsack Data" }, { url: F("2024/02/cec2000.jpg"), icon: "🖼️", tip: "사진" }] },
...
const domesticPapers = [
  ...
  { citation: '<b>Kuk-Hyun Han</b>, Yewon Shim and Jumin Park, "A study on mechanical properties and permeability of mold and core printed by sand 3D printer," in <i>Virtual Conference of the Korean Institute of Metals and Materials</i>, October 2020.', files: [{ url: F("2023/09/KIMM_Conf2020_Fall.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: '<b>Kuk-Hyun Han</b>, Jin Wook Baek, Sang-Yun Park, Tae Wan Lim and Jumin Park, "A case study on productivity innovation through convergence of sand 3D printing technology," in <i>Proceedings of the Korean Society for Precision Engineering</i>, September 2020. (Best Paper Award)', files: [{ url: F("2023/09/BestPaperAward_KSPE2020.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: '<b>Kuk-Hyun Han</b>, Jumin Park, Tae Wan Lim, Yewon Shim, Jin Wook Baek and Yubin Hwang, "A Study on the convergence design method of casting material and structural shape using sand 3D Printing," in <i>Virtual Conference of the Korean Institute of Metals and Materials</i>, July 2020.', files: [{ url: F("2023/09/KIMM_Conf2020_Spring.pdf"), icon: "📄", tip: "PDF" }] },
  ...
  { citation: 'Jumin Park, Yewon Shim, Yongsu Kim and <b>Kuk-Hyun Han</b>, "A Study on the mechanical properties of the sand 3D printing core and mold," in <i>Conference of Korea Foundry Society</i>, April 2019.', files: [{ url: F("2023/09/KFS2019_Poster.pdf"), icon: "📄", tip: "Poster PDF" }] },
  ...
  { citation: 'Sang-Yun Park, <b>Kuk-Hyun Han</b>, Ju-Min Park, Sung-Hun Kwon and Ohseop Song, "Optimum Design of Viscous Fluid Damper for Reducing the Torsional Vibration of Propulsion Shaft System," in <i>Transactions of the Korean Society for Noise and Vibration Engineering</i>, pp. 606-613, September 2015.', files: [{ url: F("2023/09/SOJDCM_2015_v25n9_606.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: 'Pil Seung Yang and <b>Kuk-Hyun Han</b>, "Information Input Interactions based on Image Sensors," in <i>Proceedings of the HCI2009</i>, January 2009.', files: [{ url: F("2023/09/HCI2009_InfoPicker.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: 'Bo Hyun Kyung, Ki-Wook Na, <b>Kuk-Hyun Han</b>, Seung-Hwan Hong, Sang-Jun Han and Bo Mi Kim, "SimpleKey: Touch Gesture-oriented Hangul Input Method based on Consonants," in <i>Proceedings of the KIPS</i>, KIPS, November 2008.', files: [{ url: F("2023/09/KIPS2008_SimpleKey.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: 'Yehoon Kim, Jong-Hwan Kim and <b>Kuk-Hyun Han</b>, "Quantum-inspired Multiobjective Evolutionary Algorithm," in <i>Proceedings of the KACC</i>, ICASE, October 2005. (Korean)', files: [{ url: F("2024/02/QMOEAKACC05.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: 'Jong-In Lee, Jung-Min Shin, <b>Kuk-Hyun Han</b> and Jae-Ook Kwon, "Implementation of OSAL to Migrate Embedded S/W from Process-based System to Thread-based System," in <i>Conference of Korean Institute of Communication and Sciences (KICS)</i>, October 2004. (Korean)', files: [{ url: F("2023/09/KICS2004_OSAL.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: '<b>Kuk-Hyun Han</b>, Kang-Hee Lee, Choon-Kyung Moon, Hoon-Bong Lee and Jong-Hwan Kim, "Strategy for Middle League MiroSot," in <i>Proceedings of the 4th Workshop on Soccer Robotics</i>, Daeyoung Press, pp. 137-142, January 2002. (Korean)', files: [{ url: F("2023/09/soccerKWS2001.pdf"), icon: "📄", tip: "PDF" }] },
...
const magazineArticles = [
  { citation: '[Interview] <b>Kuk-Hyun Han</b>, "Engine parts maker meets sand 3D printing: Samyoung Machinery pushes the limits of innovation," in <i>FA Journal Smart Factory</i>, pp. 48-49, August 2020.', files: [{ url: F("2023/09/FA_202008.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: '<b>Kuk-Hyun Han</b>, "Industry-specific innovation through 3D printing: Mass production and expansion of applications to various industries," in <i>CAD&Graphics</i>, pp. 23-27, July 2020.', files: [{ url: F("2023/09/CG_202007.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: '<b>Kuk-Hyun Han</b>, Jung-Yi Choi, Pil-Soon Choi and Se-Joong Lee, "Development of Soccer Robot – MIRAGE I (1)," <i>Semiconductor Network</i>, pp. 132-135, January 2002. (Korean)', files: [{ url: F("2023/09/semi_0201.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: '<b>Kuk-Hyun Han</b>, Jung-Yi Choi, Pil-Soon Choi and Se-Joong Lee, "Development of Soccer Robot – MIRAGE I (2)," <i>Semiconductor Network</i>, pp. 134-139, February 2002. (Korean)', files: [{ url: F("2023/09/semi_0202.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: '<b>Kuk-Hyun Han</b>, Jung-Yi Choi, Pil-Soon Choi and Se-Joong Lee, "Development of Soccer Robot – MIRAGE I (3)," <i>Semiconductor Network</i>, pp. 136-141, March 2002. (Korean)', files: [{ url: F("2023/09/semi_0203.pdf"), icon: "📄", tip: "PDF" }] }
];

const books = [
  { citation: '<b>한국현</b>, <a href="https://www.yes24.com/Product/Goods/116446689"><i>세상을 바꿀 미래기술 12가지: 인공지능부터 양자컴퓨터까지, 누구나 알아야 할 미래기술의 모든 것</i></a>, <a href="https://wikibook.co.kr/futuretech12/">위키북스</a>, 2023.', files: [{ url: F("2024/02/BookCoverTech.jpg"), icon: "🖼️", tip: "표지" }] },
  { citation: '<b>Kuk-Hyun Han</b>, "Industry-specific innovation through 3D printing: Mass production and expanding application fields to various industries," pp. 36-40 in <i>3D Printing Guide V4 (edited by CAD&Graphics)</i>, ENG Media, 2020.', files: [{ url: F("2023/09/3DPGv4_2020.pdf"), icon: "📄", tip: "PDF" }] },
  { citation: 'Jong-Hwan Kim, <b>Kuk-Hyun Han</b>, Yong-Jae Kim, Shin Kim, Kui-Hong Park, Kang-Hee Lee, Jun-su Jang, and Yong-Duk Kim, <i>Internet-based Personal Robot</i>, KAIST Press, 2004. (Korean; 인터넷 기반 퍼스널 로봇)', files: [{ url: F("2023/09/BookCoverIPR.jpg"), icon: "🖼️", tip: "표지" }] },
  { citation: 'Shin Han and <b>Kuk-Hyun Han</b>, <i>Internet Search Engines</i>, F-ONE Press, 1997. (Korean; 인터넷 검색 엔진)', files: [{ url: F("2023/09/BookCoverS.jpg"), icon: "🖼️", tip: "표지" }] }
];
...
const honors = [
  ...
  { title: 'TOP 100 Engineers 2012, <a href="http://www.internationalbiographicalcentre.com/">IBC</a>, Cambridge, England, 2012 (등재)', files: [{ url: F("2023/09/IBC-TOP100_2012.jpg"), icon: "🖼️", tip: "IBC TOP100 2012" }] },
  ...
  { title: 'TOP 100 Engineers 2009, <a href="http://www.internationalbiographicalcentre.com/">IBC</a>, Cambridge, England, 2009 (등재)', files: [{ url: F("2024/02/top100engineers2009.jpg"), icon: "🖼️", tip: "IBC TOP100 2009" }] },
  ...
  { title: '<a href="http://www.internationalbiographicalcentre.com/pages/publica.html">2000 Outstanding Intellectuals of the 21st Century</a>, <a href="http://www.internationalbiographicalcentre.com/">IBC</a>, Cambridge, England, 2006 (등재)', files: [{ url: F("2023/09/ibc2006.jpg"), icon: "🖼️", tip: "IBC 2006" }] },
  { title: '<a href="http://www.marquiswhoswho.com/products/WOprodinfo.asp">Marquis Who\'s Who in the World</a> 2006, 23rd ed., <a href="http://www.marquiswhoswho.com/">Marquis</a>, USA (등재)', files: [{ url: F("2024/02/whoswhointheworld2006.jpg"), icon: "🖼️", tip: "Who\'s Who 2006" }] }
];

/* ──────────── 조교활동 ──────────── */
const taActivities = [
  { period: "2002.03.~2002.06.", title: "지능시스템 (EE481)", files: [] },
  { period: "2001.09.~2001.12.", title: "기초전자공학실습 (EE103)", files: [{ url: F("2024/02/mirorobot.gif"), icon: "🖼️", tip: "MiroRobot" }] },
